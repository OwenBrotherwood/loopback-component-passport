...
console.log(user); // the contents of user are controlled by searchAttributes
	  if (user) {
            ...
            var profile = { // use case for including all the groups user is member of or other valus 
...
console.log(profile);
   ...
   */
  if (authType === 'local' || 'ldap') { // Owen has this OR until understand Pierre code
